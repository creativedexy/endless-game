...
- **No head, no shortcut** — every worm is an undifferentiated chain from end to end; there's no special segment to snipe for an instant kill. You have to clear the whole body, and it gets measurably tougher the deeper you cut in, so stalling partway through is a losing bet. Segment HP is far higher across the board than earlier builds.
