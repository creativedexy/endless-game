...
- **Full-width snake routes** — a different route generator each stage (zig-zag, serpentine, tightening spiral, wide funnel, staircase, double-swing), all swinging edge-to-edge across nearly the entire screen width, so you're constantly sliding the turret to keep up with the body as it winds past.
