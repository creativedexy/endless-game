...
// The defensive ridge: an impassable ring of crags with a few gaps that
// funnel everything through — the line-of-defence map twist in V3.
export const RIDGE_RADIUS = 14;
export const RIDGE_BAND = 1.4; // half-thickness of the solid band
export const GAP_ANGLES = [20, 140, 260].map((d) => (d * Math.PI) / 180);
export const GAP_HALF_WIDTH = 0.3; // radians (~17°) half-width of each gap
